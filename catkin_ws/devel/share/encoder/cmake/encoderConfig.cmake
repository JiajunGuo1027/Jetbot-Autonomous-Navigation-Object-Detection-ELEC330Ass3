...
if("TRUE" STREQUAL "TRUE")
  set(encoder_SOURCE_PREFIX /home/team5/catkin_ws/src/encoder)
  set(encoder_DEVEL_PREFIX /home/team5/catkin_ws/devel)
  set(encoder_INSTALL_PREFIX "")
  set(encoder_PREFIX ${encoder_DEVEL_PREFIX})
else()
  set(encoder_SOURCE_PREFIX "")
  set(encoder_DEVEL_PREFIX "")
  set(encoder_INSTALL_PREFIX /home/team5/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/team5/catkin_ws/src/encoder/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/team5/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  list(APPEND encoder_EXPORTED_TARGETS ${${encoder_dep}_EXPORTED_TARGETS})
endforeach()
